export const growthPromoterProducts = [
  {
    "product_name": "Nutri‑Life Fulvic Plus™",
    "promoters": ["Fulvic Acid"],
    "application": ["Soil", "Foliar", "Seed treatment"],
    "product_form": "Liquid",
    "organic_certified": true,
    "benefits": [
      "Improves nutrient solubility and availability",
      "Enhances root absorption of minerals",
  ...
  },
  {
    ...
    "promoters": ["Humic Acid"],
    "application": ["Soil", "Compost"],
    "product_form": "Liquid",
    "organic_certified": true,
    "benefits": [
      "Improves soil structure and water retention",
      "Enhances cation exchange capacity",
      "Increases nutrient retention in soil",
  ...
  },
  {
    ...
    "promoters": ["Amino Acids"],
    "application": ["Foliar", "Soil", "Seed treatment"],
    "product_form": "Liquid",
    "organic_certified": true,
    "benefits": [
  ...
  },
  {
    ...
    "promoters": ["Fulvic Acid", "Humic Acid", "Amino Acids"],
    ...
    "benefits": [
      ...
      "Enhances root development and absorption",
      "Improves stress tolerance and recovery",
      "Stimulates enzyme activity",
  ...
  },
  {
    ...
    "promoters": ["Fulvic Acid", "Amino Acids"],
  ...
  },
  {
    ...
    "organic_certified": true,
    "benefits": [
      "Enhances foliar nutrient absorption",
  ...
  },
  {
    ...
    "promoters": ["Amino Acids", "Fulvic Acid"],
    ...
    "benefits": [
      ...
      "Improves salt stress tolerance",
